...
## 检查是命令行是否输入了必要的参数
ifeq ($(SLUG),)
$(error SLUG is not set. Please provide the market slug as an argument, e.g., make SLUG=some-market-slug SIZE=10)
endif

ifeq ($(SIZE),)
$(error SIZE is not set. Please provide the market size as an argument, e.g., make SLUG=some-market-slug SIZE=10)
endif

all:
	@echo "I will create a sell order for $(SLUG)"
