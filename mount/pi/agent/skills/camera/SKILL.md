---
name: camera
description: 店铺安防监控摄像头工具，你可以访问当前最新的图片，也可以访问历史图片记录，也可以通过 VQA 对画面进行分析和提问。
---
...
- HTTP GET URL: `${BASE_URL}/xiaoer/api/fetch?bot_id=${BOT_ID}`
...
- HTTP GET URL: `${BASE_URL}/xiaoer/api/query?bot_id=${BOT_ID}&from=_START_TIME_&to=_END_TIME_`
